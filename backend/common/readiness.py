...
def deployment_readiness_payload() -> dict[str, Any]:
    checks = [
        ...
        _deployment_check("queue-provider", getattr(settings, "NETRA_QUEUE_PROVIDER", "") == "supabase-pgmq", "Supabase PGMQ is the durable queue provider.", "Set NETRA_QUEUE_PROVIDER=supabase-pgmq.", required=True),
