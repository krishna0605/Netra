...
def verify_supabase_token(token: str) -> SupabaseUser | None:
    ...
    role = app_metadata.get("netra_role") or app_metadata.get("role") or "Investigator"
    ...
    return SupabaseUser(id=payload.get("id", ""), email=email, display_name=display_name, role=role)
