...
## Parser-isolation verification snapshot

Verified on 9 August 2026 without loading production credentials:

| Image | Local image ID | Verification |
|---|---|---|
| API isolation build | `sha256:6b915f4965a7ff2ceec0e18144877180459564ebba95630a3e890e0ea77ee89c` | UID/GID 10001, Django check passes, TShark/Zeek/tcpdump absent |
| Worker isolation build | `sha256:3a1d36830052cf91cc6a3c188cb0d33092e9aa2d8d32b54a641940a29c1e0720` | UID/GID 10001, TShark 4.6.7, Zeek 8.2.1, compiler/CMake absent |
...
|---|---|---|
| API supply-chain build | `sha256:f0294fe8fd0b92258126b4494e3c55b9b56f5b43e4e49b3781bcf77a6f103cf8` | UID/GID 10001; no TShark, Zeek, or tcpdump |
| Worker supply-chain build | `sha256:6f5a2fc4323d1a1c01098b8a91000e03617c4e7f74614cdf392e35f6d477286d` | UID/GID 10001; TShark 4.6.7; Zeek 8.2.1 |
| Frontend supply-chain build | `sha256:6e5dc432f39a016bc5fa44a8ea5bbc5b1b7def4d306b45210cca5c5af8737428` | UID/GID 101; unprivileged Nginx runtime |
